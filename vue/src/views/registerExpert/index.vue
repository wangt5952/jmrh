...
<div class="tab-container" style="background: #fff;">
  <div class="textl" style="font-size:14px;height:100%;">

    <el-row :gutter="24" style="font-size: 12px;height:100%">

      <el-col :span="10" style="background: #fff; cursor: pointer;height:100%">
        <div class="" style="width: 300px;height: 120px;margin: 0 auto;background: #ccc;display:flex;justify-content:center; align-items:Center;text-align:center;">
      ...
      <el-col :span="12" style="background: #fff; margin-right: 10px;cursor: pointer;height:100%">
        <div class="txselect" style="height:100px;display:flex;width:100%">
          <div class="" style="flex:10;width: 100%;">
            <div class="" style="width: 100%;">
              ...
              <el-select v-model="input.degrees" style="width:120px;height:30px" placeholder="请选择学位">
              ...
              <el-checkbox-group v-model="input.sex" style="margin:10px 0px;float:right">
                <el-checkbox label="5">性别</el-checkbox>
              </el-checkbox-group>
              <el-checkbox-group v-model="input.education" style="margin:10px 0px;float:right">
                <el-checkbox label="6">学历</el-checkbox>
              </el-checkbox-group>
              <el-checkbox-group v-model="input.degree" style="margin:10px 0px;float:right">
