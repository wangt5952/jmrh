  ...
  <div class="">
    <div class="paddingb textl paddingr" style="font-size:14px">
      ...
      <div class="" style="padding:10px 0px;">
        <el-button v-show="userType =='0'"" @click="handleEdit" type="primary">添加高校</el-button>
...
export default {
  ...
  created(){
    this.pldcUrl = this.docUrl + '/xtcx/lib/exportLib?objName='+this.input.objName+'&checkStatus=1&userType=4&creditLevel='+this.input.creditLevel+'&status='+this.input.status+'&token='+window.sessionStorage.getItem('token')
  },
  async mounted() {
