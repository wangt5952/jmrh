...
<div class="tab-container">
  <div class="">
    <div class="paddingb textl paddingr" style="font-size:14px">
      <span>关键字</span>
      <el-input v-model="input.objName" placeholder="请输入企业名/营业执照号/领域/信用级别" style="width:20%;"></el-input>
      ...
      <div class="" style="padding:10px 0px;">
        <el-button v-show="userType =='0'" @click="handleEdit" type="primary">添加企业</el-button>
