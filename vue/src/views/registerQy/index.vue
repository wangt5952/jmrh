        ...
        <div class="txselect" style="height:100px;display:flex">
          <div class="" style="flex:10">
            <div class="">
              ...
              <!-- <el-checkbox-group v-model="input.scale" style="margin:10px 0px;float:right">
                <el-checkbox label="5">企业规模</el-checkbox>
              </el-checkbox-group> -->
              <el-checkbox-group v-model="input.regType" style="margin:10px 0px;float:right">
                <el-checkbox label="5">注册类型</el-checkbox>
              </el-checkbox-group>
              <el-checkbox-group v-model="input.isListed" style="margin:10px 0px;float:right">
