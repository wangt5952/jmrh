  ...
  <div class="">
    <div class="paddingb textl paddingr" style="font-size:14px">
      ...
      <div class="" style="padding:10px 0px;">
        <el-button  style="" @click="handleEdit" type="primary">添加服务机构</el-button>
...
export default {
  ...
  created(){
    this.pldcUrl = this.docUrl + '/xtcx/lib/exportLib?objName='+this.input.objName+'&checkStatus=1&userType=3&creditLevel='+this.input.creditLevel+'&status='+this.input.status+'&token='+window.sessionStorage.getItem('token')
  },
  async mounted() {
